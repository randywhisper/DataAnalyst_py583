...
clf = SVC(kernel = 'rbf')
clf_countUnd = SVC(kernel = 'rbf')
clf_countDir = SVC(kernel = 'rbf')
clf_proUnd = SVC(kernel = 'rbf')
clf_proDir = SVC(kernel = 'rbf')
clf_existUnd = SVC(kernel = 'rbf')
clf_existDir = SVC(kernel = 'rbf')
clf_modeUnd = SVC(kernel = 'rbf')
clf_modeDir = SVC(kernel = 'rbf')
