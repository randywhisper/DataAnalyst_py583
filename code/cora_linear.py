...
#creating relational features of the training instances	
		...
		for i in range(len(train_indices)):
			citeTrain = [0,0,0,0,0,0,0]
			citingTrain = [0,0,0,0,0,0,0]
...
#creating the relational features of testing instances
		...
		while( 0 <= index_test <10):
			for i in range(len(test_indices)):
					citeTest = [0,0,0,0,0,0,0]
					citingTest = [0,0,0,0,0,0,0]
			...
			for i in range(len(test_indices)):
					...
					for u in range(7):
						if(index_test == 0):
							...
							countTestAttDir[i][7+u] = float(citingTest[u])
			index_test = index_test + 1
			...
			for i in range(len(test_indices)):
					...
					for u in range(7):
						if(index_test == 0):
							...
							if(totalCitingTest == 0):
								proporTestAttDir[i][7+u] = 0
							else:
								proporTestAttDir[i][7+u] = round(citingTest[u]/totalCitingTest,3)
			...
			for i in range(len(test_indices)):
					...
					for u in range(7):
						if(index_test == 0):
							...
							if(citingTest[u] == 0):
								existTestAttDir[i][7+u] = 0
							else:
							 	existTestAttDir[i][7+u] = 1
			index_test = index_test + 1
