			...
			for i in range(len(test_indices)):
					...
					for u in range(3):
						if(index_test == 0):
							...
							countTestAttDir[i][3+u] = float(citingTest[u])
			index_test = index_test + 1
			...
			for i in range(len(test_indices)):
					...
					for u in range(3):
						if(index_test == 0):
							...
							if(totalCitingTest == 0):
								proporTestAttDir[i][3+u] = 0
							else:
								proporTestAttDir[i][3+u] = round(citingTest[u]/totalCitingTest,3)
			index_test = index_test + 1
			...
			for i in range(len(test_indices)):
					...
					for u in range(3):
						if(index_test == 0):
							...
							if(citingTest[u] == 0):
								existTestAttDir[i][3+u] = 0
							else:
							 	existTestAttDir[i][3+u] = 1
			index_test = index_test + 1
