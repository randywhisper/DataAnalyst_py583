...
clf_countUnd = LogisticRegression(penalty = 'L2')
clf_countDir = LogisticRegression(penalty = 'L2')
clf_proUnd = LogisticRegression(penalty = 'L2')
clf_proDir = LogisticRegression(penalty = 'L2')
clf_existUnd = LogisticRegression(penalty = 'L2')
clf_existDir = LogisticRegression(penalty = 'L2')
clf_modeUnd = LogisticRegression(penalty = 'L2')
clf_modeDir = LogisticRegression(penalty = 'L2')
