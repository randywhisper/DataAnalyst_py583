...
clf = MultinomialNB()
clf_countUnd = MultinomialNB()
clf_countDir = MultinomialNB()
clf_proUnd = MultinomialNB()
clf_proDir = MultinomialNB()
clf_existUnd = MultinomialNB()
clf_existDir = MultinomialNB()
clf_modeUnd = MultinomialNB()
clf_modeDir = MultinomialNB()
