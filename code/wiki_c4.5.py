...
clf_countUnd = DecisionTreeClassifier()
clf_countDir = DecisionTreeClassifier()
clf_proUnd = DecisionTreeClassifier()
clf_proDir = DecisionTreeClassifier()
clf_existUnd = DecisionTreeClassifier()
clf_existDir = DecisionTreeClassifier()
clf_modeUnd = DecisionTreeClassifier()
clf_modeDir = DecisionTreeClassifier()
