...
execfile("structed_Pub.py")
import copy

#exectue 5-fold cross-validation
from sklearn.svm import SVC
clf = SVC(kernel = 'linear')
clf_countUnd = SVC(kernel = 'linear')
clf_countDir = SVC(kernel = 'linear')
clf_proUnd = SVC(kernel = 'linear')
clf_proDir = SVC(kernel = 'linear')
clf_existUnd = SVC(kernel = 'linear')
clf_existDir = SVC(kernel = 'linear')
clf_modeUnd = SVC(kernel = 'linear')
clf_modeDir = SVC(kernel = 'linear')
